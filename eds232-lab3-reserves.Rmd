...
**Question 4**: What part of the study area is the 13th vegetation class found in? For instance, is it in the south-eastern part of the study area?\
...
**Question 24**: Try setting the penalty value to 0.5. What is the cost of the solution now? Is it different from the fourth solution (`s4`) (hint: try plotting the solutions to visualize them)? Is this a useful penalty value? Why (or why not)?\
```{r, out.width = "65%"}
# make prioritization problem
p5_rds <- file.path(dir_data, "p5.rds")
if (!file.exists(p5_rds) | TRUE){
